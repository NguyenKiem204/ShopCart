    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (user == null) {
            ...
            if (user.getRole().toLowerCase().equals("admin")) {
                ...
                else if (req.getRequestURI().endsWith("listuser")) {
                    req.getRequestDispatcher("listuser").forward(request, response);
                    return; 
                } 
                else if (req.getRequestURI().endsWith("listproduct")) {
                    req.getRequestDispatcher("listproduct").forward(request, response);
                    return;
                }
                else {
