    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            if (cart != null) {
                ...
                List<CartDetail> listCartItem = cartItemDAO.getCartDetailsByCartID(cartID);
               
                int numberCartItems = cartItemDAO.getCartItemCountByUserID(userID);
                request.setAttribute("number", numberCartItems);
