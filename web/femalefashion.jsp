        ...
        <div class="new-product laptop">
            <div class="main-content">
                ...
                <div class="filter-sidebar">
                    ...
                    <form method="post" action="femalefashion">
                        <div class="filter-category">
                            ...
                            <label><input type="checkbox" class="brand" name="brand" value="Quần Jeans"> Quần Jeans</label><br>
                            <label><input type="checkbox" class="brand" name="brand" value="Chân Váy"> Chân Váy</label><br>
                        </div>
                ...
                <div class="container">
                    <p class="sub-title">Thời Trang Nữ</p>
