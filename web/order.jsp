...
<html>
    ...
    <body class="dark">
     ...
     String role = (account != null && account.getRole() != null) ? account.getRole() : "";   
        ...
        <div class="container container-order mt-4">
                ...
                <div class="order">
                    <div class="store-info">
                        <div class="store-info-left">
                            ...
                            <a class="view-shop" href="sellerdetail?sellerID=${product.sellerID}">
                                Xem Shop
                            </a>
                        </div>
                        <div class="order-status">
                            <i class="status fas fa-truck">
                            </i>
                            <span class="status">
                        ...
                        <div class="order-details">
                            ...
                            <div class="price-info">
                                <span class="original-price">
                                    <fmt:formatNumber value="${product.originalPrice}" type="number" pattern="#,##0" var="formattedCurrentPrice" />
                    ...
                    <div class="order-price">
                        Thành tiền: <fmt:formatNumber value="${product.totalPrice}" type="number" pattern="#,##0" var="formattedCurrentPrice" />
                        ₫${formattedCurrentPrice.replace(",", ".")}
                    </div>
                    <div class="order-actions">
                        <button onclick="productDetail('${product.productID}')" class="btn">
                            Mua Lại
                        </button>
                        <button onclick="sellerDetail('${product.sellerID}')" class="btn contact">
                            Liên Hệ Người Bán
                        </button>
                    </div>
                </div>
