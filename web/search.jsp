                ...
                <div class="filter-sidebar">
                    ...
                    <form method="post" action="search">
                        <div class="filter-category">
                            <input type="text" style="display: none" name="searchh" value="${requestScope.input}">
                            <h4>Thương hiệu</h4>
                            <c:forEach items="${filteredKeywords}" var="keyword">
                                <label>
                                    <input type="checkbox" class="brand" name="brand" value="${keyword}" 
                                           <c:if test="${not empty selectedBrands and selectedBrands.contains(keyword)}"> checked="checked"</c:if>
                                           /> ${keyword}
                                </label><br>
                            </c:forEach>
                        </div>
                        ...
                        <div class="filter-price">
                            ...
                            <input type="number" id="min-price" name="minPrice" placeholder="Giá tối thiểu"
                                   <c:if test="${not empty minPrice}"> value="${minPrice}"</c:if>
                                       /><br>

                                   <label for="max-price">Max:</label>
                                   <input type="number" id="max-price" name="maxPrice" placeholder="Giá tối đa"
                                   <c:if test="${not empty maxPrice}"> value="${maxPrice}"</c:if>
                                       /><br>
                    ...
                    <div class="container">
                        <p class="sub-titlee" style="font-size: 18px; color: #bbb"><label style="font-size: 22px; color: #ff6633; font-weight: 550;">Kết quả tìm kiếm: </label> ${requestScope.input}</p>
