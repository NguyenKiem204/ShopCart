...
<html lang="en"> <!--begin::Head-->
    ...
    <head>
        ...
        <link rel="preload" href="./assets/css/adminprofile.css" as="style" onload="this.rel = 'stylesheet'">
        <noscript><link rel="stylesheet" href="./assets/css/adminprofile.css"></noscript>
    ...
    <%
        ...
        String phone = (account != null && account.getPhoneNumber() != null) ? account.getPhoneNumber() : "";
        String address = (account != null && account.getAddress() != null) ? account.getAddress() : "";
    ...
    %>
    <body class="layout-fixed sidebar-expand-lg bg-body-tertiary profile"> <!--begin::App Wrapper-->
            ...
            <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Start Navbar Links-->
                    ...
                    <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                        ...
                        <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="<%=imgURL%>" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">NguyenKiem</span> </a>
                ...
                <div class="sidebar-wrapper">
                    <nav class="mt-2"> <!--begin::Sidebar Menu-->
                        <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                            <li class="nav-item"> <a href="seller" style="color: #fff !important; background-color: rgba(255, 255, 255, 0.1)" class="nav-link"> <i class="nav-icon bi bi-palette"></i>
                            ...
                            <div class="profile-card">
                                <div class="row">
                                    <div class="col-md-4 text-center d-flex justify-content-center align-items-center">
                                        <img src="<%=imgURL%>" alt="Ảnh cá nhân" class="img-fluid rounded-circle profile-img">
                                    </div>
                                    <div class="col-md-8 d-flex flex-column justify-content-center">
                                        ...
                                        <button class="btn edit-button mt-4">Chỉnh sửa thông tin</button>
                                    </div>
                                </div>
                            </div>
                        </div>
